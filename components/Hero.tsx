...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center bg-duabg overflow-hidden px-6 pt-24">
      {/* Background image via Next.js Image para otimização automática WebP/AVIF */}
      <Image
      ...
      {/* Background grid */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(204,255,0,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(204,255,0,0.03)_1px,transparent_1px)] bg-[size:50px_50px] z-[1]" />
      <div className="container mx-auto max-w-5xl relative z-10 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a href="#contato" aria-label="Quero mais informações sobre a Dua Criativa">
