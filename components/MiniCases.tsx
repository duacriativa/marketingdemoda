...
const CASES = [
  {
    ...
    tag: "Meta Ads + Social",
    before: { label: "Faturamento", value: "R$ 35k/mês" },
    after: { label: "Faturamento", value: "R$ 110k/mês" },
    metric: "3,1× em 90 dias",
    quote: "A Dua entendeu nossa marca desde o primeiro dia. Os resultados vieram rápido.",
  },
  {
    brand: "Loja de Varejo · SP",
    tag: "Tráfego Pago",
  ...
  {
    brand: "Atacado Moda Praia · CE",
    tag: "Google + Meta",
    before: { label: "CPL", value: "R$ 12,50" },
    after: { label: "CPL", value: "R$ 1,35" },
    metric: "−89% no custo por lead",
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-black text-white mb-4">
            Resultados que provam o método{" "}
            <span className="text-dualime"></span>
          </h2>
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-5">
                  <div className="text-center">
                    ...
                    <div className="font-bold text-gray-500 line-through text-lg">
                      {c.before.value}
                    </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="font-black text-dualime text-2xl">
                      {c.after.value}
                    </div>
                ...
                <div className="text-gray-400 text-sm italic">{c.quote}</div>
              </div>
            </motion.div>
          ))}
        </div>
